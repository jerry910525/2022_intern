# -*- coding: utf-8 -*-
"""
This code use quantum layer as convulotion 2d layers and use GPU to train the model.
However, with sufficient data, we need roughly 16 qubits to acehieve 80% accuracy while it takes a day to train.
"""
...
print('GPU:', torch.cuda.get_device_name()) #check if it can detect GPU device
...
n_train = 1     # Size of the train dataset
...
filter_size = 2
circ = QuanvCircuit(filter_size, backend, 0, 127)
